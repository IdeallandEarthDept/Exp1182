...
//import com.deeplake.exp1182.varia.CustomEnergyStorage;
...
//        super(ModBlocks.POWERGEN_CONTAINER.get(), windowId);
...
//        return stillValid(ContainerLevelAccess.create(blockEntity.getLevel(), blockEntity.getBlockPos()), playerEntity, ModBlocks.POWERGEN.get());
//    }
//
//    @Override
